...
brew "zsh-fast-syntax-highlighting" # Fast syntax highlighting for Zsh
brew "zsh-autosuggestions"         # Fish-like autosuggestions for Zsh
brew "starship"                    # Cross-shell prompt with minimal config
brew "atuin"                       # Magical shell history with SQLite backend
...
brew "k3d"                         # k3s in Docker - local Kubernetes
brew "k9s"                         # Kubernetes TUI manager
...
brew "btop"                        # Resource monitor with rich UI
...
cask "makemkv"                     # DVD/Blu-ray to MKV converter
cask "kap"                         # Screen recorder with GIF export
